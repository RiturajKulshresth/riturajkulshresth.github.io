...
export default function CoreVisualizer({ colorPreset = "COSMIC" }: CoreVisualizerProps) {
  ...
  return (
    <div
      ...
      className={`border ${overdrive ? "border-fuchsia-500/40 shadow-[0_0_16px_rgba(255,0,255,0.12)]" : `${theme.border} ${theme.glow}`} p-3.5 rounded relative overflow-hidden bg-[#05050b]/88 flex flex-col justify-between transition-colors duration-300`}
    >
      {/* Corner Brackets */}
